...
describe('Tests the AccountsHandler methods and behaviors', () => {
  ...
  describe('tests the transfer method', () => {
    ...
    it('should add an account if a transfer is made to a non existing account', () => {
      ...
      accountsHandler.transfer(transferDetails.origin, transferDetails.destination, transferDetails.value);
    ...
    it('should alter the balances of the origin and destination account', () => {
      ...
      const transferDetails = { origin: originAccount.id, destination: destinationAccount.id, value: 100 };
      ...
      expect(accountsHandler.getBalanceFromAccount(destinationAccount.id)).toBe(destinationFinalBalance);
    });
  });
});
